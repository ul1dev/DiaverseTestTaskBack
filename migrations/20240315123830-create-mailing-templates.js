...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('MailingTemplates', {
      id: {
    ...
    await queryInterface.sequelize.query(`
      ...
      BEFORE UPDATE ON "MailingTemplates"
      FOR EACH ROW
  ...
  async down(queryInterface) {
    await queryInterface.sequelize.query(`
      DROP TRIGGER IF EXISTS update_users_updated_at ON "MailingTemplates";
      DROP FUNCTION IF EXISTS update_updated_at_column();
    `);
    await queryInterface.dropTable('MailingTemplates');
  },
};
